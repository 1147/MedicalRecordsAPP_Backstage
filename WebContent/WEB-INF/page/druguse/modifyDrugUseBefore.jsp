		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="druguse!modifyDrugUseAfter" method="post">
										<input type="hidden" name="druguse.ID" value="${druguse.ID }">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="druguse.druguse_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${druguse.druguse_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 病历信息编号： </label>

											<div class="col-sm-9">
												<input type="text" name="druguse.medical_ID" id="form-field-1" class="col-xs-10 col-sm-5 "  value="${druguse.medical_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 药品编号： </label>

											<div class="col-sm-9">
												<input type="text" name="druguse.drug_ID" id="form-field-1" class="col-xs-10 col-sm-5"  value="${druguse.drug_ID }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 药量： </label>

											<div class="col-sm-9">
												<input type="text" name="druguse.druguse_num" id="form-field-1" class="col-xs-10 col-sm-5"  value="${druguse.druguse_num }"/>
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">单位：克</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 当前时间： </label>

											<div class="col-sm-9">
												<input type="text" name="druguse.druguse_time" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker"  value="${druguse.druguse_time }" style="width:357px;" />
											</div>
										</div>
										<div class="space-4"></div>
