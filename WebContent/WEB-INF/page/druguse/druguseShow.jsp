									...
									<hr>
											...
											<form action="druguse">
												...
												查询条件：<select  id="form-field-select-1" name="id" >
																				...
																				<option value="2">病历信息ID</option>
																				<option value="3">药品编号</option>
																				<option value="4">药量（次数）</option>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th style="text-align:center;">病历信息ID</th>	
														<th style="text-align:center;">药品编号</th>	
														<th style="text-align:center;">药量（次数）</th>	
												...
												<s:iterator value="pagination.list">
													<tr>
														<td id="dialog" style="text-align:center;">${druguse_ID }</td>
														<td style="text-align:center;"><a href="javascript:;" onclick="medicalOnclick('${medical_ID }');">${medical_ID }</a></td>
														<td style="text-align:center;"><a href="javascript:;" onclick="drugOnclick('${drug_ID }');">${drug_ID }</a></td>
														<td style="text-align:center;">${druguse_num }</td>
														<td style="text-align:center;">${druguse_time }</td>
														<td>
														<button class="btn btn-warning btn-xs">
															<i class="icon-wrench  bigger-110 icon-only"></i>
															<s:url id="url" action="druguse" method="modifyDrugUseBefore">
																<s:param name="druguse.druguse_ID" value="druguse_ID" />
...
<![endif]-->
		<script type="text/javascript">
			function medicalOnclick(e){
				layer.open({
				    type: 2,
				    title: '病历信息',
				    skin: 'layui-layer-rim', //加上边框
				    area: ['500px', '300px'], //宽高
				    content: '${ctx}/dep/ment/dialogShow!showMedByID?medical.medical_ID='+e
				});
			}
