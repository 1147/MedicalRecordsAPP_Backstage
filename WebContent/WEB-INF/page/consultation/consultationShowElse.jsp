								...
								<span class="input-icon">
									...
									<form action="consultation">
											...
											查询条件：<select  id="form-field-select-1" name="idd" onchange="mytype()">
																			...
																			<option value="2">发送者编号</option>
																			<option value="3">接收者编号</option>
											 	</select>
										 	</span>
										...
										<hr>
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<s:iterator value="pagination.list">
													<tr>
														<td id="dialog">${ID }</td>
														<td>${consultation_sendID }</td>
														<td>${consultation_getID }</td>
														<td>${consultation_msg}</td>
														<td>${consultation_time}</td>
													</tr>
												</s:iterator>
												</tbody>
											</table>
									...
									<jsp:include page="pagination_util.jsp" >
										<jsp:param value="consultation?idd=${idd}&search_id=${search_id }" name="url"/>
									</jsp:include>
								</div>
