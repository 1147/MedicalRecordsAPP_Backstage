			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="maindepartment!modifyMainDepartmentAfter.action" method="post">
										<input type="hidden" name="maindepartment.ID" value="${maindepartment.ID }">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 科室编号： </label>

											<div class="col-sm-9">
												<input type="text" name="maindepartment.maindepartment_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${maindepartment.maindepartment_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 科室名称： </label>

											<div class="col-sm-9">
												<input type="text" name="maindepartment.maindepartment_name" id="form-field-1" class="col-xs-10 col-sm-5"  value="${maindepartment.maindepartment_name }"/>
											</div>
										</div>
										<div class="space-4"></div>
