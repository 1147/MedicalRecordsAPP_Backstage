			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								...
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="maindepartment!insertMinorDepartmentAfter.action" method="post">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 科室编号： </label>

											<div class="col-sm-9">
												<input type="text" name="minordepartment.minordepartment_ID" id="form-field-1" class="col-xs-10 col-sm-5 "/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="minordepartment.minordepartment_name" id="form-field-1" class="col-xs-10 col-sm-5"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 所属科室名称： </label>
