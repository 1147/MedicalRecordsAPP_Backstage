									...
									<input type="hidden" id="minordepartment" value="${id}"/>
										...
										<button class="btn btn-xs" style="color:#428bca!important;">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td style="text-align:center;"> ${maindepartment.maindepartment_name}</td>
														<td style="text-align:center;">
														<button class="btn btn-warning btn-xs">
															<i class="icon-wrench  bigger-110 icon-only"></i>
															<s:url id="url" action="maindepartment" method="modifyMinorDepartmentBefore">
											...
											<jsp:include page="pagination_util_other.jsp">
												<jsp:param value="maindepartment!showMinordepartment?maindepartment.maindepartment_ID=${id}" name="url"/>
											</jsp:include>
										</div>
									</div>
								</div>
