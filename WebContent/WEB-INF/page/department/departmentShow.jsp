						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<span class="input-icon">
									...
									<hr>
									<form action="maindepartment">
											<span class="col-xs-3">
											查询条件：<select  id="form-field-select-1" name="idd" onchange="mytype()">
																			<option value="0">--请选择--</option>
																			<option value="1">科室编号</option>
																			<option value="2">科室名称</option>
											 	</select>
										 	</span>
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											...
											<button class="btn btn-xs" style="color:#428bca!important;">
															...
															<s:url id="url" action="maindepartment" method="insertMainDepartmentBefore">
															</s:url> <s:a href="%{url}" style="color:black;">增加科室</s:a>
											</button><hr>
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<s:iterator value="pagination.list">
													<tr>
														<td id="dialog" style="text-align:center;">${maindepartment_ID }</td>
									...
									<jsp:include page="pagination_util.jsp">
										<jsp:param value="maindepartment?idd=${idd}&search_id=${search_id }" name="url"/>
									</jsp:include>
								</div>
