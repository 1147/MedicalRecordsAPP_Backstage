...
<link href="${ctx}/assets/css/bootstrap.min.css" rel="stylesheet" />
  ...
  <script src="${ctx}/assets/js/highchart/highcharts-3d.js"></script>
    ...
    $(function() {
    	...
    	var id = $("#guoaomen").val();
    	var idTimeStart = $("#idTimeStart").val();
    	var idTimeEnd = $("#idTimeEnd").val();
    	$.ajax({
			type : "post",
			dataType : "json",
			url : '${ctx}/dep/ment/highchart!getLiDocString?id='+id+'&idTimeStart='+idTimeStart+'&idTimeEnd='+idTimeEnd,
			success : function(data) {
				var date = [];
				var date2 = [];
				$.each(data, function(idx, item) {
					date2.push(item.docname);
					date.push(item.num);
				})
				charts.addSeries({
					name : '就医量',
				...
				charts.xAxis[0].setCategories(date2);
			},
			error : function(e) {
				alert(e);
			}
...
<div class="navbar navbar-default" id="navbar">
			...
			<input type="hidden" value="${id }" id="guoaomen">
			<input type="hidden" value="${idTimeStart }" id="idTimeStart">
			<input type="hidden" value="${idTimeEnd }" id="idTimeEnd">
						...
						<div class="input-group">
							<form action="highchart!showDocHighchart" id="guoaomen2">
								<div class="page-header">
									...
									<input type="text" name="idTimeStart" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" value="${idTimeStart }" data-toggle="tooltip" data-placement="bottom" title="请选择开始时间" style="width:150px;" />
									<input type="text" name="idTimeEnd" data-date-format="yyyy-mm-dd" id="id-date-picker-2" class="form-control date-picker" value="${idTimeEnd }" data-toggle="tooltip" data-placement="bottom" title="请选择终止时间" style="width:150px;" />
