  ...
  <script src="${ctx}/assets/js/highchart/highcharts-3d.js"></script>
    ...
    $(function () {
    	...
    	$.ajax({
			type : "post",
			dataType : "json",
			url : '${ctx}/dep/ment/highchart!getLiDepString?idTimeStart='+idTimeStart+'&idTimeEnd='+idTimeEnd,
					...
					<div class="page-content">
						<div class="input-group">
							...
							<form action="highchart!showDocHighchart" id="guoaomen2">
								...
								开始时间：<input type="text" name="idTimeStart" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker" data-toggle="tooltip" data-placement="bottom" title="请选择开始时间" style="width:150px;" />
								终止时间：<input type="text" name="idTimeEnd" data-date-format="yyyy-mm-dd" id="id-date-picker-2" class="form-control date-picker" data-toggle="tooltip" data-placement="bottom" title="请选择终止时间" style="width:150px;" />
