					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<form action="departmentanddoctor!modifyDepartmentAndDoctorAfter" method="post" id="form_doc">
								<div>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													<div class="profile-info-name"> 医生编号 </div>
													<div class="profile-info-value">
														<span class="editable" id="username">
															<input type="hidden" name="doctorBaseInfo.ID" value="${doctorBaseInfo.ID}">
															<input type="hidden" name="doctorBaseInfo.doctorInfo_pwd" value="${doctorBaseInfo.doctorInfo_pwd}">
															<input type="hidden" name="doctorBaseInfo.state" value="${doctorBaseInfo.state}">
															<input type="text" name="doctorBaseInfo.doctorInfo_ID" value="${doctorBaseInfo.doctorInfo_ID}" size="50" readonly style="border-style:none;padding:10">
															<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>

												<div class="profile-info-row">
													<div class="profile-info-name"> 医生姓名 </div>

													<div class="profile-info-value">
														<span class="editable" id="country">
														<input type="text" name="doctorBaseInfo.doctorInfo_name" value="${doctorBaseInfo.doctorInfo_name}" size="50" readonly style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 医生性别 </div>
													<input type="hidden" name="doctorBaseInfo.doctorInfo_sex" value="${doctorBaseInfo.doctorInfo_sex}">
													<div class="profile-info-value">
														<span class="editable" id="age">
														<select  class="select" style="width:365px;" disabled="disabled">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<input type="text" name="doctorBaseInfo.doctorInfo_birthday" value="${doctorBaseInfo.doctorInfo_birthday}" readonly size="50" style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<input type="text" name="doctorBaseInfo.doctorInfo_address" value="${doctorBaseInfo.doctorInfo_address}" readonly size="50" style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<input type="text" name="doctorBaseInfo.doctorInfo_record" value="${doctorBaseInfo.doctorInfo_record}" readonly size="50" style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
													...
													<div class="profile-info-value">
														...
														<i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">填‘普通’或者‘专家’</span>
														</span>
													</div>
												</div>
													<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about">
														<input type="text" name="doctorBaseInfo.doctorInfo_phone" value="${doctorBaseInfo.doctorInfo_phone}" size="50" readonly style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
													...
													<div class="profile-info-value">
														<span class="editable" id="about">
														<input type="text" name="doctorBaseInfo.doctorInfo_email" value="${doctorBaseInfo.doctorInfo_email}" size="50" readonly style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
													...
													<div class="profile-info-value">
														<span class="editable" id="about">
														<input type="text" name="doctorBaseInfo.doctorInfo_disease" value="${doctorBaseInfo.doctorInfo_disease}" readonly size="50" style="border-style:none;padding:10">
														<i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span>
														</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													<div class="profile-info-name"> 所属科室 </div>

													<div class="profile-info-value">
														<span class="editable" id="about">
															<select name="departmentDeploy.minordepartment_ID" class="select">
																<s:iterator value="list">
																	<option value="${minordepartment_ID}" id="${minordepartment_ID}">${minordepartment_name }</option>		
																</s:iterator>
															</select>
														</span>
													</div>
											...
											<button class="btn" type="reset">
												...
												<input type="hidden" value="${minordepartment.minordepartment_ID }" id="abc">
											</div>
