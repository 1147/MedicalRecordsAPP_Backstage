		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="hospitalbaseinfo!modifyHospitalAfter" enctype="multipart/form-data" method="post" >
										<input type="hidden" name="hospital.ID" value="${hospital.ID }">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院编号： </label>

											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${hospital.hospital_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院名称： </label>

											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_name" id="form-field-1" class="col-xs-10 col-sm-5"  value="${ hospital.hospital_name }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院地址： </label>

											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_address"  id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_address }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院图片： </label>

											<div class="col-sm-9">
												<!-- <input type="file" id="id-input-file-2"> -->
												<div >
													<div  style="width:352px;">
														<input type="hidden" name="fileFileName" value="${hospital.hospital_photo}">
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-9"> 医院简介： </label>

											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_info" id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_info }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_phone" id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_phone }"/>
												&nbsp;<i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">按格式填写：区号-电话号码,例如（0551-8828338）</span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院网站： </label>

											<div class="col-sm-9">
												<input type="text" name="hospital.hospital_webSite" id="form-field-1" class="col-xs-10 col-sm-5"  value="${hospital.hospital_webSite }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 医院状态： </label>
											<div class="col-sm-9">
												<label>
												<c:if test="${hospital.hospital_state==1}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="hospital.hospital_state" class="ace ace-switch ace-switch-2" id="timeState" type="checkbox" checked value="1" onclick="changeTime()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="time">运营中</span>
												</c:if>
												<c:if test="${hospital.hospital_state==0}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="hospital.hospital_state" class="ace ace-switch ace-switch-2" id="timeState" type="checkbox" value="0" onclick="changeTime()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="time">歇业中</span>
												</c:if>
								...
								<input type="hidden" id="photo" value="${hospital.hospital_photo}">
