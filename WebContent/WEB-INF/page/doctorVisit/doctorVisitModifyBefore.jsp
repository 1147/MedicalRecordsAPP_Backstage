		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" role="form" action="doctorVisit!modifydoctorVisitAfter.action" id="form_doc">
										<input type="hidden" name="doctorVisit.ID" value="${doctorVisit.ID }">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 编号： </label>

											<div class="col-sm-9">
												<input type="text" name="doctorVisit.doctorVisit_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${doctorVisit.doctorVisit_ID }" />
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="doctorVisit.doctorInfo_ID" id="form-field-1" class="col-xs-10 col-sm-5" readonly value="${doctorVisit.doctorInfo_ID }"/>
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 时间类型： </label>

											<div class="col-sm-9">
												<select class="form-control" id="form-field-select-1" name="doctorVisit.doctorVisit_timeType" style="width:357px;">
													<option>--请选择--</option>
													<option value="上午" id="上午">上午</option>
													<option value="下午" id="下午">下午</option>
												</select>
											</div>
										</div>
										<input type="hidden" value="${doctorVisit.doctorVisit_timeType }" id="abc">
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-9"> 可挂号数量： </label>

											<div class="col-sm-9">
												<input type="text" name="doctorVisit.doctorVisit_regNunber" id="form-field-1" class="col-xs-10 col-sm-5"  value="${doctorVisit.doctorVisit_regNunber }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 反馈意见： </label>

											<div class="col-sm-9">
												<textarea class="form-control limited" name="doctorVisit.doctorVisit_feedback" id="form-field-9"  style="margin: 0px 492px 0px 0px; width: 356px; height: 44px;">${doctorVisit.doctorVisit_feedback }</textarea>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 反馈状态： </label>

											<div class="col-sm-9">
												<label>
												<c:if test="${doctorVisit.doctorVisit_confirmState==1}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="doctorVisit.doctorVisit_confirmState" class="ace ace-switch ace-switch-2" id="idd" type="checkbox" checked value="1" onclick="changeState()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="state">确认</span>
												</c:if>
												<c:if test="${doctorVisit.doctorVisit_confirmState==0}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="doctorVisit.doctorVisit_confirmState" class="ace ace-switch ace-switch-2" id="idd" type="checkbox" value="0" onclick="changeState()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="state">未确认</span>
												</c:if>
										...
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 时间状态： </label>
											<div class="col-sm-9">
												<label>
												<c:if test="${doctorVisit.doctorVisit_state==1}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="doctorVisit.doctorVisit_state" class="ace ace-switch ace-switch-2" id="timeState" type="checkbox" checked value="1" onclick="changeTime()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="time">已过时</span>
												</c:if>
												<c:if test="${doctorVisit.doctorVisit_state==0}">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input name="doctorVisit.doctorVisit_state" class="ace ace-switch ace-switch-2" id="timeState" type="checkbox" value="0" onclick="changeTime()"/>
													<span class="lbl"></span>
													&nbsp;&nbsp;&nbsp;<span class="badge badge-info" id="time">未过时</span>
												</c:if>
