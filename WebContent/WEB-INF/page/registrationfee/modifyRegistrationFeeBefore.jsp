		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="registrationfee!modifyRegistrationFeeAfter.action" method="post">
										<input type="hidden" name="registrationfee.ID" value="${registrationfee.ID }">
										<input type="hidden" name="registrationfee.hospital_ID" value="${registrationfee.hospital_ID }">
										<input type="hidden" name="registrationfee.doctorInfo_type" value="${registrationfee.doctorInfo_type }">
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 编号： </label>

											<div class="col-sm-9">
												<input type="text" name="registrationfee.registrationfee_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${registrationfee.registrationfee_ID }" />
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="registrationfee.doctorInfo_typeName" id="form-field-1" class="col-xs-10 col-sm-5"  value="${registrationfee.doctorInfo_typeName }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 挂号费： </label>

											<div class="col-sm-9">
												<input type="text" name="registrationfee.registrationfee_fee" id="form-field-1" class="col-xs-10 col-sm-5"  value="${registrationfee.registrationfee_fee }"/>
										...
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" id="save_doc" onclick="myChange()">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function myChange(){
				var te = $('#form-field-select-1 option:selected').text();//选中的文本
				$("#bcd").val(te);
			}
		</script>
</body>
