						...
						<div class="nav-search" id="nav-search">
							<form class="form-search">
								<span class="input-icon">
									...
									<hr>
											<div >
											<form action="registrationfee">
												<span class="col-xs-3">
												查询条件：<select  id="form-field-select-1" name="id" >
																				<option value="0">--请选择--</option>
																				<option value="1">编号</option>
																				<option value="2">坐诊类型</option>
																				<option value="3">挂号费</option>
												 	</select>
											 	</span>
											 	<span class="col-xs-3">
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											...
											<button class="btn btn-xs" style="color:#428bca!important;">
															...
															<s:url id="url" action="registrationfee" method="insertRegistrationFeeBefore">
															</s:url> <s:a href="%{url}" style="color:black;">增加坐诊类型</s:a>
											</button><hr>
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th style="text-align:center;">挂号费（元）</th>	
														<th>操作</th>
												</thead>
												<tbody>
												<s:iterator value="pagination.list">
													<tr>
														<td id="dialog" style="text-align:center;">${registrationfee_ID }</td>
														<td style="text-align:center;">
															<span class="label label-xlg label-primary arrowed arrowed-right">${doctorInfo_typeName}</span>
														</td>
														<td style="text-align:center;">${registrationfee_fee }</td>
														<td>
														<button class="btn btn-warning btn-xs">
															<i class="icon-wrench  bigger-110 icon-only"></i>
															<s:url id="url" action="registrationfee" method="modifyRegistrationFeeBefore">
																<s:param name="registrationfee.registrationfee_ID" value="registrationfee_ID" />
									...
									<jsp:include page="pagination_util.jsp">
										<jsp:param value="registrationfee" name="url"/>
									</jsp:include>
								</div>
...
<![endif]-->
		...
		$(function () {
			...
			var i1 = $("#i1").val();
			if(i==1){
				toastr.success('坐诊类型增加成功！');
			}
			if(i1==1){
				toastr.success('挂号费基本信息修改成功！');
			}
			if(id==null){
