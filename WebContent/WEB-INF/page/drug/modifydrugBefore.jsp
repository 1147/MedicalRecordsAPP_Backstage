		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<hr>
								<div class="col-xs-12">
									<form class="form-horizontal" id="form_doc" role="form" action="drug!modifyDrugAfter" method="post">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="drug.drug_ID" id="form-field-1" class="col-xs-10 col-sm-5 " readonly value="${drug.drug_ID }" />
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-remove-sign red"></i>&nbsp;<span class="middle">不可编辑</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 药品（设备）名称： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_name" id="form-field-1" class="col-xs-10 col-sm-5 "  value="${drug.drug_name }" />
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 剂量： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_num" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_num }"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="drug.drug_price" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_price }"/>
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">单位：元</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 生产日期： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_time" data-date-format="yyyy-mm-dd" id="id-date-picker-1" class="form-control date-picker"  value="${drug.drug_time }" style="width:357px;" />
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 保质期： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_period" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_period }"/>
												<span class="help-inline col-xs-12 col-sm-7"><i class="icon-angle-right bigger-110"></i>&nbsp;<span class="middle">单位：天</span></span>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 制药厂： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_produce_factory" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_produce_factory }"/>
											</div>
										</div>
										<div class="space-4"></div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 药品类型： </label>

											<div class="col-sm-9">
												<input type="text" name="drug.drug_style" id="form-field-1" class="col-xs-10 col-sm-5"  value="${drug.drug_style }"/>
											</div>
										</div>
										<div class="space-4"></div>
